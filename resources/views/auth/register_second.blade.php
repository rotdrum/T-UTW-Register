...
<form class="vue-register" enctype="multipart/form-data"  method="POST" action="{{ route('postregister2') }}" onSubmit="return check();" name="register">
    @csrf
        <div class="vue-container">
            <div class="vue-card">
                ...
                @endforeach
                <h2 class="h2">แบบลงทะเบียนการสมัครเข้าศึกษาต่อ ชั้น ม.4</h2>
                ...
                <div class="row">
                    <div class="form-group">
                        <p class="">สำเร็จการศึกษาชั้น ม.3 จากโรงเรียน </p>
                        <select id="name_school_se" class="" name="" required>
                            <option value="">--- เลือกโรงเรียน ---</option>
                            <option value="u4">ทัพทันอนุสรณ์</option>
                            <option value="u1">เทศบาลวัดมณีสถิตกปิฎฐาราม</option>
                            <option value="u1">เทศบาลวัดหลวงราชาวาส</option>
                            <option value="u2">บ้านหลุมเข้ามิตรภาพที่ 117</option>
                            <option value="c3">บ้านหนองขุ่น</option>
                            <option value="u1">พุทธมงคลวิทยา</option>
                            <option value="u3">หนองฉางวิทยา</option>
                            <option value="u3">อุทัยธรรมานุวัตรวิทยา</option>
                            <option value="u1">อุทัยวิทยาคม</option>
                ...
                <div class="row">
                    <p>แผนการเรียน ( ต้องเลือกให้ครบ 3 ลำดับ ไม่ซ้ำกัน )</p>
                    <div class="form-group">
                        <p class="">อันดับที่ 1</p>
                        <select  name="rank_edu1" required>
                            <option value="">--- เลือก ---</option>
                        ...
                        <p class="">อันดับที่ 2</p>
                        <select  name="rank_edu2" required>
                            <option value="">--- เลือก ---</option>
                            <option value="วิทย์-คณิต">วิทย์-คณิต</option>
                            <option value="ศิลป์-คำนวณ">ศิลป์-คำนวณ</option>
                            <option value="ศิลป์-สังคม">ศิลป์-สังคม</option>
                        </select>
                        <p class="">อันดับที่ 3</p>
                        <select  name="rank_edu3" required>
                            <option value="">--- เลือก ---</option>
                            <option value="วิทย์-คณิต">วิทย์-คณิต</option>
                            <option value="ศิลป์-คำนวณ">ศิลป์-คำนวณ</option>
                            <option value="ศิลป์-สังคม">ศิลป์-สังคม</option>
                        </select>
                        <span>*หมายเหตุ : เรียงลำดับ 1-3 ตามแผนการเรียนที่ประสงค์ โดยคณะกรรมการจะพิจารณานักเรียนจากแผนการเรียนตามลำดับคะแนนที่สอบได้ และจำนวนที่สามารถรับได้ ในแผนการเรียนนั้นๆ</span>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group">
                        <p class="" >มีความสามารถพิเศษ ( ถ้าไม่มีใส่เครื่องหมาย - )</p>
                        <input type="text"  name="extra" class="txt-form" placeholder="ระบุความสามารถพิเศษ" required>
                    </div>
                </div>
                <br><br>
