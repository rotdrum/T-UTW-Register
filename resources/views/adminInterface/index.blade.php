...
<script>
    ...
    <div class="vue-register">
        <div class="vue-container">
            <div class="vue-card">
                <h2>ตรวจสอบรายชื่อผู้สมัคร</h2>

                <p class="suggest">ค้นหาจากเลขประจำตัวผู้สมัคร หรือ เลขบัตรประชาชน หรือ ชื่อจริง</p>
                <form class="article-search"  method="GET" action="{{ route('searchindexadmin') }}">
                    @csrf
                ...
                <div class="table">
                    ...
                    <div class="tr">
                        ...
                        @elseif( $studentone->status == 2 )          
                            <div class="td success"><p>สถานะการสมัคร</p><i class="fas fa-circle"></i>ผ่าน</div>
                        @endif
                    </div> 
                    @endforeach
