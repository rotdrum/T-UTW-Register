        ...
        <div class="vue-container">
            <div class="vue-card">
                ...
                <div class="btn-manage">
                    <a href="{{route('getapprove1', $id)}}" class="btn-approve">อนุมัติ</a>
                    <a href="{{route('deletestudent', $id)}}" class="btn-notApprove">ไม่อนุมัติ/ลบข้อมูล</a>
                </div>

                @foreach ($students as $student)
                <form class="vue-register" enctype="multipart/form-data"  method="POST" action="{{ route('updatesstudentone') }}">
                    @csrf
