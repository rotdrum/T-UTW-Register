...
<body>
    ...
    <div class="print">
        ...
        <div class="print-card" id="printableArea">
            ...
            <div class="p-content">
                <b>กำลังศึกษาชั้น ป.6 </b><span>{{ $student->name_school }}</span>
            ...
            <div class="p-content" style="margin: 30px;">
                มีความประสงค์จะสมัครสอบคัดเลือกเข้าเรียนประเภทในเขตพื้นที่บริการ/ทั่วไปชั้นมัธยมศึกษาปีที่ 1 ปีการศึกษา {{ $y }}
            </div>
            @endforeach
            ...
            <div class="p-header">
                <br>
                <h2>ตารางสอบชั้นมัธยมศึกษาปีที่ 1 ปีการศึกษา  {{ $y }}</h2>
                <h2>ประเภทห้องเรียนปกติ</h2>
                <h3>วันเสาร์ที่ 6 มิถุนายน พ.ศ. 2563 สนามสอบ โรงเรียนอุทัยวิทยาคม</h3>
